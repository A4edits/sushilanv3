...
module.exports = {
    ...
    BOTABU: process.env.BOTV2_NAME === undefined ? '  sushilanv3  \n\n   *ωнαтsαρρ вσт™*   \n' : process.env.BOTV2_NAME,
    ...
    INSTA: process.env.INSTA_LINK === undefined ? 'https://instagram.com/__ahmd_ali_' : process.env.INSTA_LINK,
    GROUP: process.env.GROUP_LINK === undefined ? 'https://chat.whatsapp.com/JhcYanAWH2G87NNHwPGmXD' : process.env.GROUP_LINK,
    YAK: process.env.YAK === undefined ? '919967413665,0' : process.env.YAK,
    OA_NAME: process.env.DEPLOYER === undefined ? 'Aexd-ali' : process.env.DEPLOYER,
    OWNERSHIP: process.env.OWNER_SHIP === undefined ? 'sushilanv3' : process.env.OWNER_SHIP,
    MWOL: process.env.BGM_DURATION === undefined ? '7280542' : process.env.BGM_DURATION,
    BOT: process.env.BOT_NAME === undefined ? 'ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝sushilanv3 ' : process.env.BOT_NAME,
    ABU_AI: process.env.ABU_AI === undefined ? 'false' : process.env.ABU_AI,
    ALIVEBUTTON: process.env.ALIVEBUTTON === undefined ? '*hey...👀♥️*' : process.env.ALIVEBUTTON,
    ALIVE_BUTTON: process.env.ALIVE_BUTTON === undefined ? '*hey...👀♥️*' : process.env.ALIVE_BUTTON,
    LG_LOGO: process.env.ALL_IMG === undefined ? 'https://i.imgur.com/AbfyTEH.png' : process.env.ALL_IMG,
    LOGO_NAME: process.env.ALL_NAME === undefined ? 'ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝sushilanv3 ࿐' : process.env.ALL_NAME,
    ...
    SUDO: process.env.SUDO === undefined ? '919967413665' : process.env.SUDO,
    DEBUG: DEBUG,
